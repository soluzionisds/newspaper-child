			...
			<?php if ( bbp_is_user_home() || current_user_can( 'edit_user', bbp_get_displayed_user_id() ) ) : ?>
				...
				<li class="<?php if ( bbp_is_single_user_edit() ) :?>current<?php endif; ?>">
					<span class="bbp-user-edit-link">
						<a href="<?php bbp_user_profile_edit_url(); ?>" title="<?php printf( esc_attr__( "Edit %s's Profile", 'bbpress' ), bbp_get_displayed_user_field( 'display_name' ) ); ?>"><?php esc_html_e( 'Edit Your Profile', 'bbpress' ); ?></a>
					</span>
				</li>

				<?php
					$mepr_account_page = get_page_by_path( 'account' );
					if ($mepr_account_page) :
				?>
					<li>
						<span class="bbp-user-mepr-account-link">
							<a href="<?php echo get_permalink($mepr_account_page) ?>" title="<?php echo get_the_title($mepr_account_page) ?>"><?php echo get_the_title($mepr_account_page) ?></a>
						</span>
					</li>
				<?php endif; ?>
