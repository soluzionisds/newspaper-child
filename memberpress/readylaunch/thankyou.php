...
<div class="mepr-signup-form mepr-form">
  ...
  <div class="invoice-wrapper thankyou">
    <!-- original template change: --><h2 class="" style="display: none;"><?php _ex( 'Thank you for your purchase', 'ui', 'memberpress' ); ?></h2>
    <?php include get_stylesheet_directory() . '/memberpress/custom-inclusion/readylaunch-thankyou.php'; ?>
