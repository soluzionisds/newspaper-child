<div class="mp_wrapper">
	...
	<?php if(!empty($unauth->message)): ?>
	  <div class="mepr-unauthorized-message li-paywall<?php if(empty($unauth->excerpt)): ?> li-paywall--top-spacer<?php endif; ?>">
	...
	<?php if(!MeprUtils::is_user_logged_in()): ?>
	  ...
	  <?php if($show_login): ?>
			<?php echo $form; ?>
		  <?php // disabling login link in every case
			//elseif(is_singular()): //Let's not show the annoying login link on non singular pages ?>
